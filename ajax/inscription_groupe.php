 ...
 */
$mail->setFrom('ferossenailles@hotmail.fr');
                                                               ...
                                                               <tbody>
                                                                  <tr>
                                                                     <td align="center" width="100%">
                                                                        <h1 style="padding:0;margin:0;color:#ffffff;font-weight:500;font-size:20px;line-height:24px">Inscription de groupe</h1>
                                                                     </td>
                                                                  </tr>
                                                               </tbody>
                                                            </table>
                                                               ...
                                                               <tbody>
                                                                  <tr>
                                                                     <td align="center" width="100%" style="padding: 0 15px;text-align: justify;color: rgb(76, 76, 76);font-size: 12px;line-height: 18px;">
                                                                        <h3 style="font-weight: 600; padding: 0px; margin: 0px; font-size: 16px; line-height: 24px; text-align: center;" class="title-color">Bonjour vous avez re&ccedilu un message de la part de, '.$_POST['nom_rep'].' '.$_POST['prenom_rep'].', concernant une inscription pour le Festival GOSPELoire</h3>
                                                                        <p style="margin: 20px 0 30px 0;font-size: 15px;text-align: center;">Nom du groupe: '.$_POST['nom_groupe'].'</p>
                                                                        <p style="margin: 20px 0 30px 0;font-size: 15px;text-align: center;">E-mail du groupe: '.$_POST['email_groupe'].'</p>
                                                                        <p style="margin: 20px 0 30px 0;font-size: 15px;text-align: center;">N&ordm du groupe: '.$_POST['tel'].'</p>
                                                                     </td>
                                                                  </tr>
                                                               </tbody>
                                                            </table>
...
if(!$mail->Send()){ //Teste le return code de la fonction
    ...
    $data['message'] = '<b>Votre demande a été prise en compte !<b> Vous recevrez une réponse d\'ici quelques jours.';
    $data['success']  = true;
}
$mail->SmtpClose();
unset($mail);
